...
include("incconnection.php");
	...
	if(isset($_POST['sign_up'])){
		...
		$rand = rand(1, 3); //Random number between 1 and 3
			...
			if($rand == 1)
			{
				$profile_pic ="../images/head_red.jpg";
			}
			else if($rand == 2)
			{
				$profile_pic ="../images/head_sun_flower.jpg";
			}
			else if($rand == 3)
			{
		...
		$insert = "insert into admin (f_name,l_name,user_name,Relationship,user_pass,user_email,user_country,user_gender,user_birthday,user_image,user_cover,user_reg_date,posts,recovery_account)
		values('$first_name','$last_name','$username','...','$pass','$email','$country','$gender','$birthday','$profile_pic','../images/default_cover.jpg',NOW(),'$posts','Type Best Friend Name.')";
