...
<div class="row">
	<div class="col-sm-12">
		<div class="main-content">
			...
			<div class="l-part">
				<form name="signupForm" onsubmit="return validateForm()" action="home.html" method="POST" >
					...
					<center><input type="submit" value="Submit" id="signup" class="btn btn-info btn-lg" name="sign_up"></input></center>
				</form>
			</div>
		</div>
	</div>
