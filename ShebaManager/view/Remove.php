...
<html>
 ...
 <body>
  <div class="container">
   <br />
   <h3 align="center">Remove Offers</h3><br />
   <?php
   ...
   <?php
    ...
    {
   ?>
     <tr id="<?php echo $row["o_id"]; ?>" >
      <td><?php echo $row["o_name"]; ?></td>
      <td><?php echo $row["o_details"]; ?></td>
      <td><input type="checkbox" name="customer_id[]" class="delete_customer" value="<?php echo $row["o_id"]; ?>" /></td>
     </tr>
   <?php
    }
   ?>
