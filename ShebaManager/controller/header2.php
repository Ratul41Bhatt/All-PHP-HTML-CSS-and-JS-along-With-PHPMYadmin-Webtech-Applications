	...
	<body>
		<nav class="navbar navbar-default">
			<div id="re"class="container-fluid">
				<div class="navbar-header">
					...
					<a class="navbar-brand" href="home.php">Sheba Website</a>
				</div>
		...
		?>  
			    ...
			    <li><a href="Home.php">Home</a></li>
					<li><a href="Service_Page.php">Service Management Page</a></li>
					<li><a href="Add.php">Add Offers</a></li>
					<li><a href="Remove.php?u_id=new">Remove Offers</a></li>
