    ...
    function fetch_data()
    {
        $.ajax({
            ...
            success:function(data)
            {
                ...
                {
                    html += '<tr>';
                    html += '<td><input type="checkbox" id="'+data[count].Programid+'" data-name="'+data[count].ProgramName+'" data-address="'+data[count].Details+'" data-gender="'+data[count].Status+'"  class="check_box"  /></td>';
                    html += '<td>'+data[count].ProgramName+'</td>';
                    html += '<td>'+data[count].Details+'</td>';
