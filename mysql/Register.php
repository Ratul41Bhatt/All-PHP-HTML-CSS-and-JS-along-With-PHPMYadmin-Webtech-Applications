...
if (empty($_POST["mail"]))
{
 ...
 if ($unErr ==""&& $passErr==""&&$fnameErr==""&&$lErr==""&&$BdErr==""&&$relerr==""&&$prerr==""&&$pererr==""&&$phoneerr==""&&$emailerr==""&&$linkerr=="") {
   ...
   $u_name = $_POST['u_name'];
   $pass = $_POST['pass'];
    $sql = "INSERT INTO user (f_name,l_name,u_birthday,gender,Religion,u_address,per_address,Phone,u_link,mail,u_name,pass) VALUES ('$firstname','$lastname','$u_birthday','$gender','$Religion','$u_address','$per_address','$Phone','$u_link','$mail','$u_name','$pass')";
...
<center><a href="Login.php">Sign-In</a><br><br></center>
