      ...
      $gender = $_POST['gender'];
	    ...
	    $per_address = $_POST['Permanent'];
		  $Phone = $_POST['Phone'];
			...
			$u_name = $_POST['u_name'];
			$pass = $_POST['pass'];
			if (empty($firstname) or empty($lastname) or empty($gender) or empty($u_birthday) or empty($Religion)or empty($u_address) or empty($per_address) or empty($Phone) or empty($u_link) or empty($mail) or empty($u_name) or empty($pass)) {
