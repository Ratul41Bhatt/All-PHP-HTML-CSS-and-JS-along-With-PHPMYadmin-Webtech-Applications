...
<div class="row">
 ...
 <div class="col-sm-6">
 	<div class="load_msg" id="scroll_messages">
 		<? php 
          $sel_msg = "select * from user_messages where (user_to ='$user_to_msg' AND user_from= '$user_from_name') OR (user_from='$user_to_msg' AND user_to='user_from_msg') ORDER by 1 ASC";
