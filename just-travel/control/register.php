...
if (isset($_POST["register"])) {
    ...
    if ($nameError == "" && $emailError == "" && $usernameError == "" && $passError == "" && $cpassError == "" && $genderError == "" && $dobError == "" ) {
        if (file_exists("../model/user.txt")) {
            ...
            $myuser = $Name . "|" . $Username . "|" . $Password . "|" . $Email . "|" . $Gender . "|" . $DoB ."\r\n";
        ...
        <div>
            <fieldset style="width: 60%">
                <form method="POST" action="" enctype="multipart/form-data">
                    ...
                    <i class="fas fa-lock"></i>&nbsp;&nbsp;&nbsp;<input type="text" id="pass" name="pass" value="<?php if (isset($pass)) {
                                                                                                                        echo $pass;
                    ...
                    <fieldset style="width:60%">
                        ...
                        <input type="radio" id="gender" name="gender" value="Male" size="50"> Male
                        <input type="radio" id="gender" name="gender" value="Female" size="50"> Female
                        <input type="radio" id="gender" name="gender" value="Other" size="50"> Other &nbsp; <span style="color:red">
                            <?php
                            if ($genderError != "") {
                                echo "* - " . $genderError;
                            }
